...
class App
  ...
  def create_rental
    ...
    @books.each_with_index { |book, i| puts "#{i}) #{book.title} #{book.author}" }
  ...
  def list_rentals
    ...
    @rentals.each do |rental|
      puts "#{rental.book.title} was rented by #{rental.person.name} on #{rental.date}" if rental.person.id == id.to_i
    end
  end
end
